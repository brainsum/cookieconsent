...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=o(require("./Utilities"));function o(e){return e&&e.__esModule?e:{default:e}}function i(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}function n(e,o){for(var i=0;i<o.length;i++){var n=o[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function t(e,o,i){return o&&n(e.prototype,o),i&&n(e,i),e}var r=function(){function o(){i(this,o)}return t(o,[{key:"init",value:function(){this.removeUnwantedCookies()}},{key:"removeUnwantedCookies",value:function(){var o=[],i=window.CookieConsent.config;for(var n in document.cookie.split(";").map(function(e){o.push(e.split("=")[0].replace(/(^\s*)|(\s*&)/,""))}),i.services)if("Array"===e.default.objectType(i.services[n].cookies)&&!i.categories[i.services[n].category].wanted)for(var t in i.services[n].cookies){var r=e.default.objectType(i.services[n].cookies[t]);if("String"===r)o.indexOf(i.services[n].cookies[t])>-1&&this.removeCookie(i.services[n].cookies[t]);else if("RegExp"===r)for(var c in o)o[c].match(i.services[n].cookies[t])&&this.removeCookie(o[c])}}},{key:"removeCookie",value:function(e){document.cookie="".concat(e,"=; expires=Thu, 01 Jan 1980 00:00:00 UTC; domain=").concat(window.location.hostname,"; path=/;"),document.cookie="".concat(e,"=; expires=Thu, 01 Jan 1980 00:00:00 UTC; domain=.").concat(window.location.hostname,"; path=/;")}}]),o}();exports.default=r;
