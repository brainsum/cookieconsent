...
var Interface = /*#__PURE__*/function () {
  ...
  _createClass(Interface, [{
    ...
    value: function buildModal() {
      ...
      function modalTabGroups() {
        ...
        for (var key in window.CookieConsent.config.categories) {
          ...
          contentItems.push((0, _redom.el)('dl.ccm__tabgroup' + '.' + key + (window.CookieConsent.config.categories[key].checked ? '.checked-5jhk' : ''), {
            'data-category': key
          }, (0, _redom.el)('dt.ccm__tab-head', (0, _redom.el)('button#ccm__tab-trigger--' + tabId + '.ccm__tab-trigger', (0, _redom.el)('span.ccm__tab-head__text', _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'name')), (0, _redom.el)('span.ccm__tab-head__status' + (window.CookieConsent.config.categories[key].checked ? '.ccm__tab-head__status--checked' : '.ccm__tab-head__status--unchecked'), window.CookieConsent.config.categories[key].checked ? '✔' : '×', {
            'aria-label': window.CookieConsent.config.categories[key].checked ? _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'checked') : _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'unchecked')
          }), (0, _redom.el)('span.ccm__tab-head__icon-wedge', (0, _redom.el)(document.createElementNS("http://www.w3.org/2000/svg", "svg"), {
            version: "1.2",
          ...
          })), (0, _redom.el)('dd#ccm__tab-content--' + tabId + '.ccm__tab-content', (0, _redom.el)('div.ccm__tab-content__inner', (0, _redom.el)('div.ccm__tab-content__desc', (0, _redom.el)('h3#ccm__tab-content__title--' + tabId, _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'name')), (0, _redom.el)('p', _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'description')), (0, _redom.el)('div.ccm__list', listCookies(key))), {
            'role': 'region',
            'aria-labelledby': 'ccm__tab-trigger--' + tabId,
            'aria-hidden': 'true'
          }, (0, _redom.el)('div.ccm__tab-content__choose', !window.CookieConsent.config.categories[key].needed && (0, _redom.el)('div.ccm__switch-component', (0, _redom.el)('span.ccm__switch__status.status-off', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'off')), (0, _redom.el)('button.ccm__switch-group', (0, _redom.el)('span.ccm__switch__text.visually-hide', _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'name')), (0, _redom.el)('span.ccm__switch__slider'), {
            'role': 'switch',
            'data-category': key,
            'aria-checked': window.CookieConsent.config.categories[key].checked,
            'aria-label': _Language.default.getTranslation(window.CookieConsent.config.categories[key], window.CookieConsent.config.language.current, 'name')
          }), (0, _redom.el)('span.ccm__switch__status.status-on', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'on'))))))));
          i++;
        }
      ...
      return (0, _redom.el)('dialog#cconsent-modal', (0, _redom.el)('div.ccm__content', (0, _redom.el)('div.ccm__content__heading', (0, _redom.el)('h2#ccm__content__title', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainTitle')), (0, _redom.el)('p', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainText'), window.CookieConsent.config.modalMainTextMoreLink ? (0, _redom.el)('a', {
        href: window.CookieConsent.config.modalMainTextMoreLink,
        target: '_blank',
        rel: 'noopener noreferrer'
      }, _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'learnMore')) : null), (0, _redom.el)('button.ccm__cheading__close', '×', {
        'aria-label': _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'closeAriaLabel')
    ...
    value: function addEventListeners(elements) {
      ...
      this.elements['modal'].querySelector('.ccm__tabs').addEventListener('click', function (event) {
        ...
        if (event.target.classList.contains('ccm__switch-group')) {
          ...
          window.CookieConsent.config.categories[event.target.dataset.category].wanted = window.CookieConsent.config.categories[event.target.dataset.category].checked = status === 'true' ? true : false;
          ...
          if (status !== 'true') {
            event.target.setAttribute('aria-label', label + ' ' + _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'enabled'));
            dt.classList.add('checked-5jhk');
          } else {
            event.target.setAttribute('aria-label', label + ' ' + _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'disabled'));
            dt.classList.remove('checked-5jhk');
          }
        }
      ...
      language: {
        ...
        locale: {
          ...
          hu: (_hu = {
            ...
            off: 'Ki',
            enabled: 'bekapcsolva.'
          }, _defineProperty(_hu, "enabled", 'kikapcsolva.'), _defineProperty(_hu, "checked", 'kipipálva'), _defineProperty(_hu, "checked", 'nincs kipipálva'), _hu)
        }
      },
      categories: {},
      services: {}
